...
class Ganesha(object):
    ...
    def get_daemons_status(cls):
        ...
        for instance in instances:
            if instance.service_cluster_id is None:
                instance.service_cluster_id = "_default_"
            if instance.service_cluster_id not in result:
                result[instance.service_cluster_id] = {}
            result[instance.service_cluster_id][instance.nodename] = {
