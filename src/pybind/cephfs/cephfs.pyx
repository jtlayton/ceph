...
cdef class LibCephFS(object):
    ...
    def stat(self, path):
        ...
        return StatResult(st_dev=stx.stx_dev, st_ino=stx.st_ino,
                          st_mode=stx.st_mode, st_nlink=stx.st_nlink,
                          st_uid=stx.st_uid, st_gid=stx.st_gid,
                          st_rdev=stx.st_rdev, st_size=stx.st_size,
                          st_blksize=stx.st_blksize,
                          st_blocks=stx.st_blocks,
                          st_atime=datetime.fromtimestamp(stx.st_atime.tv_sec),
                          st_mtime=datetime.fromtimestamp(stx.st_mtime.tv_sec),
                          st_ctime=datetime.fromtimestamp(stx.st_ctime.tv_sec))
    ...
    def fstat(self, fd):
        ...
        return StatResult(st_dev=stx.st_dev, st_ino=stx.st_ino,
                          st_mode=stx.st_mode, st_nlink=stx.st_nlink,
                          st_uid=stx.st_uid, st_gid=stx.st_gid,
                          st_rdev=stx.st_rdev, st_size=stx.st_size,
                          st_blksize=stx.st_blksize,
